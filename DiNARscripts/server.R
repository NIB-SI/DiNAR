...
shinyServer(
  ...
  function(input, output, session) {
    ...
    observe({
      TIP$a <- paste('Select a background knowledge network: Arabidopsis thaliana Comprehensive Knowledge Network (CKN), Solanum tuberosum Immune Signalling (PIS) or Custom Network.', 
